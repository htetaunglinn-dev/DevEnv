...
export interface IPost extends Document {
  ...
  category: 'general' | 'news' | 'tutorial' | 'lifestyle' | 'technology' | 'other';
  tags: string[];
...
PostSchema.methods.toggleLike = function(this: IPost, userId: mongoose.Types.ObjectId): Promise<IPost> {
